define("UsrConcerts_FormPage", /**SCHEMA_DEPS*/ ["@creatio-devkit/common"] /**SCHEMA_DEPS*/ , function /**SCHEMA_ARGS*/(sdk) /**SCHEMA_ARGS*/ {
    return {
        viewConfigDiff: /**SCHEMA_VIEW_CONFIG_DIFF*/ [{
            ...
            {
                "operation": "insert",
                "name": "RunProcessAutoAddPerformancesMenuItem",
                "values": {
                    "type": "crt.MenuItem",
                    "caption": "#ResourceString(RunProcessAutoAddPerformancesMenuItem_caption)#",
                    "visible": true,
                    "clicked": {
                        "request": "usr.AutoAddPerformancesRequest"
                    },
        ...
        handlers: /**SCHEMA_HANDLERS*/ [{
                ...
                handler: async (request, next) => {
                    ...
                    //const endpoint = "http://localhost/OtbasyDev/0/rest/ConcertsService/GetTotalDurationByConcertCode";
            ...
            },
            {
                request: "usr.AutoAddPerformancesRequest",
                handler: async (request, next) => {
                    const concertId = await request.$context.Id;

                    await request.$context.executeRequest({
                        type: "crt.RunBusinessProcessRequest",
                        $context: request.$context,
                        processName: "UsrAutoAddPerformancesProcess",
            ...
            },
            {
                ...
                handler: async (request, next) => {
                    request.$context.ServerMessageReceivedFunc = async function(event, message) {
                        if (message.Header.Sender !== "UsrPerformancesAdded") {
                            return;
                        }

                        const currentConcertId = String(await this.Id);

                        if (String(message.Body) !== currentConcertId) {
                            return;
                        }
